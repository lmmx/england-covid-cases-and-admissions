...
ukhsa_national_case_csv = "data/ukhsa_national_covid_case_rates_and_admissions.csv"
...
case_y_original = "newCasesBySpecimenDate"
...
def main():
    ...
    adm_case_df[case_y_lab].plot()#x=x_lab, y=case_y_lab)
    adm_case_df[adm_y_lab].plot()#x=x_lab, y=adm_y_lab)
    ...
    plt.legend()
    plt.show()
    #plt.savefig("plots/cases_and_admissions.png")
